...
# Adcionar a coluna _data_coleta com a data e hora atuais
df['_data_coleta'] = datetime.now()

# Tratar os valores nulos para colunas numéricas e de textos
...
# Tratar os preços com floats e calcular os valores totais
...
# Conectar ao bonco de dados SQLite (ou criar um novo)
